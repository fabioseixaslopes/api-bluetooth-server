...
class Application(dbus.service.Object):
    ...
    def register_app_callback(self):
        print("Bluetooth Peripheral started.")
    ...
    def run(self):
        ...
        BT_TIMEOUT = variables["bt_timeout"]
        json_file.close()
        self.t = threading.Timer(BT_TIMEOUT, self.quit) # started timer for timeout
        self.t.start()
        self.mainloop.run()

    def quit(self):
        print("GATT application terminated/timed out.")
